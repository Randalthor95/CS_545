...
# sgd:RMSE train =  1.2101699214626052, RMSE on testing data =  3.997331181374681 <br>
# adam: RMSE train =  0.4850645089846979, RMSE on testing data =  4.712390251849031 <br>
# scg:RMSE train =  0.4791416167469642, RMSE on testing data =  5.040969809802834 <br>
# In each case I had a lower RMSE for train then test. My RMSE values were all close to 4 to 5k away from the price. This isn't terrible and was within one std but I thought I could do better. <br>
# 
...
# sgd: RMSE train =  0.7740032582383043, RMSE on testing data =  6.547991811487444  <br>
# adam: RMSE train =  0.003590835025032428, RMSE on testing data =  3.7436244244818893  <br>
# scg: RMSE train =  1.9731602537866494e-06, RMSE on testing data =  15.056206232544147  <br>
# In each case I had a lower RMSE for train then test. In this case my sgd was worse, my adam was a little better, and the scg was was off in test. Given how low the RMSE was in train I'd guess it had over-fit. <br>
# 
...
# sgd: RMSE train =  2.3214070952859966, RMSE test =  3.392093568319404  <br>
# adam: RMSE train =  2.143758013148467, RMSE test =  4.4989761895535745 <br>
# scg: RMSE train =  2.1078788303166776, RMSE test =  3.5407576752193437 <br>
# In each case I had a lower RMSE for train then test. My values were even lower this time, with the sgd getting down to 3.39. Simplicity seemed to be a boon! This was encouraging.  <br>
# 
...
# sgd: RMSE train =  4.81468125580166, RMSE test =  4.174842041096564 <br>
# adam: RMSE train =  4.8146813886738276, RMSE test =  4.174969597848278  <br>
# scg: RMSE train =  4.814681255801662, RMSE test =  4.174842002199572  <br>
# In each case I had a lower RMSE for rest rather then train, which was unusual. My RMSE values were all very close to 4.17 in test. The was a rather interesting result. <br>
# 
...
# sgd: RMSE train = 0.009069283838888949, RMSE test =  0.01001548657911317  <br>
# adam:RMSE train =  0.00023675052020279318, RMSE test =  0.009050891811115692 <br>
# scg: RMSE train =  RMSE train =  0.00010664290533137513, RMSE test =  0.00014187502074775534 <br>
# In each case I had a lower RMSE for train then test. All of the methods had very low RMSE's for train and Test. Quality was scored between 0 and 10 so  the tiny RMSE's showed the model did an excellent job of predicting.<br>
# 
...
# sgd:   RMSE train =  6.205384876123847e-16, RMSE test =  6.157403759463129e-16 <br>
# adam: RMSE train =  0.0023635907805951255, RMSE test =  0.0023752053331788582 <br>
# scg:  RMSE train =  9.853298721926366e-09, RMSE test =  8.432362896973621e-09 <br>
